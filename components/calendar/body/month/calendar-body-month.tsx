...
export default function CalendarBodyMonth() {
  const { date, events, setDate, setMode, setEvents } = useCalendarContext();
  ...
  const createPlaceholderEvent = (date: Date) => {
    setEvents((prev) => [
      ...prev,
      {
        id: undefined,
